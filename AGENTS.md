...
- **Scope:** Restricted scenes in early phases; procedural meshes; **torus** is the current export-bin mesh — follow open milestones in the breakdown doc (**Phase 2 remaining:** **PointLight**, optional stretch CPU perspective, lighting parity; **Phase 3:** **`wgpu`**).
