...
Although both graphs show that performance worsens as mesh detail and resolution increase, we're not drawing conclusions yet. At some point we'll take a closer look at improving it. For now, we'll just record the baseline.
