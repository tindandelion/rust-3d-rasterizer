...
This release was a small detour: correct facing, then back to basic shading on the [project breakdown][project-breakdown] — a light direction and a simple diffuse term on the faceted cube, still with quads and no depth buffer.
